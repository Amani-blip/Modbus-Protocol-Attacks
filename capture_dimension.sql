...
SELECT
    ...
    COUNT(CASE WHEN Lower("SYNFlag") = 'set' THEN 1 END) as "SYNCount",
    COUNT(CASE WHEN LOWER("Protocol") = 'arp' AND (LOWER("DstMAC") = 'broadcast' OR "DstOUI" = 'ff:ff:ff') THEN 1 END) as "NumARPRequestsSent"
FROM
    public."PacketOutput"
GROUP BY
    "CaptureName"
...
ALTER TABLE public."CaptureDimension"
ADD COLUMN "CaptureKey" SERIAL PRIMARY KEY;